...
interface VRAM_A_MODES {
	LCD: VRAM_MODES["LCD"];
	MAIN_BG: VRAM_MODES["MAIN_BG"];
	MAIN_BG_0x20000: VRAM_MODES["MAIN_BG_0x20000"];
	MAIN_BG_0x40000: VRAM_MODES["MAIN_BG_0x40000"];
	MAIN_BG_0x60000: VRAM_MODES["MAIN_BG_0x60000"];
	MAIN_SPRITE: VRAM_MODES["MAIN_SPRITE"];
	MAIN_SPRITE_0x20000: VRAM_MODES["MAIN_SPRITE_0x20000"];
	TEXTURE_0: VRAM_MODES["TEXTURE_0"];
	TEXTURE_1: VRAM_MODES["TEXTURE_1"];
	TEXTURE_2: VRAM_MODES["TEXTURE_2"];
	TEXTURE_3: VRAM_MODES["TEXTURE_3"];
}
interface VRAM_B_MODES extends VRAM_A_MODES {}
interface VRAM_C_MODES {
	LCD: VRAM_MODES["LCD"];
	ARM7_0: VRAM_MODES["ARM7_0"];
	ARM7_1: VRAM_MODES["ARM7_1"];
	MAIN_BG: VRAM_MODES["MAIN_BG"];
	MAIN_BG_0x20000: VRAM_MODES["MAIN_BG_0x20000"];
	MAIN_BG_0x40000: VRAM_MODES["MAIN_BG_0x40000"];
	MAIN_BG_0x60000: VRAM_MODES["MAIN_BG_0x60000"];
	SUB_BG: VRAM_MODES["SUB_BG"];
	TEXTURE_0: VRAM_MODES["TEXTURE_0"];
	TEXTURE_1: VRAM_MODES["TEXTURE_1"];
	TEXTURE_2: VRAM_MODES["TEXTURE_2"];
	TEXTURE_3: VRAM_MODES["TEXTURE_3"];
}
interface VRAM_D_MODES {
	LCD: VRAM_MODES["LCD"];
	ARM7_0: VRAM_MODES["ARM7_0"];
	ARM7_1: VRAM_MODES["ARM7_1"];
	MAIN_BG: VRAM_MODES["MAIN_BG"];
	...
	MAIN_BG_0x40000: VRAM_MODES["MAIN_BG_0x40000"];
	MAIN_BG_0x60000: VRAM_MODES["MAIN_BG_0x60000"];
	SUB_SPRITE: VRAM_MODES["SUB_SPRITE"];
	TEXTURE_0: VRAM_MODES["TEXTURE_0"];
	TEXTURE_1: VRAM_MODES["TEXTURE_1"];
	TEXTURE_2: VRAM_MODES["TEXTURE_2"];
	TEXTURE_3: VRAM_MODES["TEXTURE_3"];
}
interface VRAM_E_MODES {
	LCD: VRAM_MODES["LCD"];
	MAIN_BG: VRAM_MODES["MAIN_BG"];
	MAIN_SPRITE: VRAM_MODES["MAIN_SPRITE"];
	MAIN_BG_EXT_PALETTE_0: VRAM_MODES["MAIN_BG_EXT_PALETTE_0"];
	TEXTURE_PALETTE_0: VRAM_MODES["TEXTURE_PALETTE_0"];
}
interface VRAM_F_MODES {
	LCD: VRAM_MODES["LCD"];
	MAIN_BG: VRAM_MODES["MAIN_BG"];
	MAIN_BG_0x4000: VRAM_MODES["MAIN_BG_0x4000"];
	MAIN_BG_0x10000: VRAM_MODES["MAIN_BG_0x10000"];
	MAIN_BG_0x14000: VRAM_MODES["MAIN_BG_0x14000"];
	MAIN_SPRITE: VRAM_MODES["MAIN_SPRITE"];
	MAIN_SPRITE_0x4000: VRAM_MODES["MAIN_SPRITE_0x4000"];
	MAIN_SPRITE_0x10000: VRAM_MODES["MAIN_SPRITE_0x10000"];
	MAIN_SPRITE_0x20000: VRAM_MODES["MAIN_SPRITE_0x20000"];
	MAIN_BG_EXT_PALETTE_0: VRAM_MODES["MAIN_BG_EXT_PALETTE_0"];
	MAIN_BG_EXT_PALETTE_2: VRAM_MODES["MAIN_BG_EXT_PALETTE_2"];
	MAIN_SPRITE_EXT_PALETTE: VRAM_MODES["MAIN_SPRITE_EXT_PALETTE"];
	TEXTURE_PALETTE_0: VRAM_MODES["TEXTURE_PALETTE_0"];
	TEXTURE_PALETTE_1: VRAM_MODES["TEXTURE_PALETTE_1"];
	TEXTURE_PALETTE_4: VRAM_MODES["TEXTURE_PALETTE_4"];
	TEXTURE_PALETTE_5: VRAM_MODES["TEXTURE_PALETTE_5"];
}
interface VRAM_G_MODES extends VRAM_F_MODES {}
interface VRAM_H_MODES {
	LCD: VRAM_MODES["LCD"];
	SUB_BG: VRAM_MODES["SUB_BG"];
	SUB_BG_EXT_PALETTE: VRAM_MODES["SUB_BG_EXT_PALETTE"];
}
interface VRAM_I_MODES {
	LCD: VRAM_MODES["LCD"];
	SUB_BG_0x8000: VRAM_MODES["SUB_BG_0x8000"];
	SUB_SPRITE: VRAM_MODES["SUB_SPRITE"];
	SUB_SPRITE_EXT_PALETTE: VRAM_MODES["SUB_SPRITE_EXT_PALETTE"];
}
type VRAM_A_MODE = VRAM_A_MODES[keyof VRAM_A_MODES];
type VRAM_B_MODE = VRAM_B_MODES[keyof VRAM_B_MODES];
type VRAM_C_MODE = VRAM_C_MODES[keyof VRAM_C_MODES];
type VRAM_D_MODE = VRAM_D_MODES[keyof VRAM_D_MODES];
type VRAM_E_MODE = VRAM_E_MODES[keyof VRAM_E_MODES];
type VRAM_F_MODE = VRAM_F_MODES[keyof VRAM_F_MODES];
type VRAM_G_MODE = VRAM_G_MODES[keyof VRAM_G_MODES];
type VRAM_H_MODE = VRAM_H_MODES[keyof VRAM_H_MODES];
type VRAM_I_MODE = VRAM_I_MODES[keyof VRAM_I_MODES];
declare var VRAM: {
	A: VRAM_A_MODES;
	B: VRAM_B_MODES;
	C: VRAM_C_MODES;
	...
	H: VRAM_H_MODES;
	I: VRAM_I_MODES;
	setBankA(mode: VRAM_A_MODE): void;
	setBankB(mode: VRAM_B_MODE): void;
	setBankC(mode: VRAM_C_MODE): void;
	setBankD(mode: VRAM_D_MODE): void;
	setBankE(mode: VRAM_E_MODE): void;
	setBankF(mode: VRAM_F_MODE): void;
	setBankG(mode: VRAM_G_MODE): void;
	setBankH(mode: VRAM_H_MODE): void;
	setBankI(mode: VRAM_I_MODE): void;
};
